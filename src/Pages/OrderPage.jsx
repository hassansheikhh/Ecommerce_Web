            ...
            <Box flex={1} padding={3}>
                ...
                <Grid container spacing={3}>
                    ...
                    <Grid item xs={12} md={4}>
                        <Card>
                            <CardContent>
                                <Typography variant="h6" marginBottom={2} fontWeight="bold" color="blue">
                                    Pending
                                </Typography>
                    ...
                    <Grid item xs={12} md={4}>
                        <Card>
                            <CardContent>
                                <Typography variant="h6" marginBottom={2} fontWeight="bold" color="orangered">
                                    Shipped
                                </Typography>
                                <Typography variant="h4">567 Orders</Typography>
                                <Typography variant="body2" color="text.secondary">
                    ...
                    <Grid item xs={12} md={4}>
                        <Card>
                            <CardContent>
                                <Typography variant="h6" marginBottom={2} fontWeight="bold" color="green">
                                    Delivered
                                </Typography>
                                <Typography variant="h4">150 Orders</Typography>
                                <Typography variant="body2" color="text.secondary">
                                    Total orders this month
                                </Typography>
                            </CardContent>
